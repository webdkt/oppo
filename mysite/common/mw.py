...
import sys
#from common.decorator import PublicView
...
class LoginRequiredMiddleware(object):
    ...
    def process_view(self, request, view_func, view_args, view_kwargs):
        if request.user.is_authenticated() or self.matches_public_path(request.path) : #or self.matches_public_view(view_func):  #or isinstance(view_func, PublicView)
            return None
        else:
